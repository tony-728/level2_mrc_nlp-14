...
def main():
    ...
    training_args = TrainingArguments(
        ...
        report_to="wandb" if config["wandb"] else None,  # wandb logging
    )

    model_args.model_name_or_path = config["model_name_or_path"]  # config에서 입력받도록 수정
    data_args.dataset_name = config["train_dataset"]  # config에서 입력받도록 수정
...
def run_mrc(
    ...
    # train, validatoin의 column_name은 동일하다
